...
<head>
    ...
    <title>Rapport de Couverture Pédagogique</title>
    <style>
        body {
...
<body>
    <h1>Rapport de Couverture Pédagogique</h1>

    <div class="meta">
        <p>Filtre: <strong>{{ ucfirst($filterType) }}</strong> | Généré le: <strong>{{ $date }}</strong></p>
    </div>
        ...
        <tbody>
            @forelse($data as $item)
                <tr>
                    ...
                    <!-- Heures -->
                    <td style="text-align: center;">{{ $item['total_planned']['hours'] ?? 0 }}</td>
                    <td style="text-align: center;">{{ $item['total_done']['hours'] ?? 0 }}</td>
                    <td class="percentage 
                    ...
                    <!-- Leçons -->
                    <td style="text-align: center;">{{ $item['total_planned']['lesson'] ?? 0 }}</td>
                    <td style="text-align: center;">{{ $item['total_done']['lesson'] ?? 0 }}</td>
                    <td class="percentage 
                    ...
                    <!-- Leçons Digitalisées -->
                    <td style="text-align: center;">{{ $item['total_planned']['lesson_dig'] ?? 0 }}</td>
                    <td style="text-align: center;">{{ $item['total_done']['lesson_dig'] ?? 0 }}</td>
                    <td class="percentage 
                    ...
                    <!-- TP -->
                    <td style="text-align: center;">{{ $item['total_planned']['tp'] ?? 0 }}</td>
                    <td style="text-align: center;">{{ $item['total_done']['tp'] ?? 0 }}</td>
                    <td class="percentage 
                    ...
                    <!-- TP Digitalisés -->
                    <td style="text-align: center;">{{ $item['total_planned']['tp_dig'] ?? 0 }}</td>
                    <td style="text-align: center;">{{ $item['total_done']['tp_dig'] ?? 0 }}</td>
                    <td class="percentage 
