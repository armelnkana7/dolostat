...
<body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true"
    ...
    <!--begin::Livewire Confirm Integration Script-->
    <script>
        document.addEventListener('livewire:init', function() {
            if (window.Livewire) {
                // Émettre openConfirm depuis les boutons de suppression
                window.livewireConfirm = {
                    openConfirm: function(data) {
                        window.Livewire.emit('openConfirm', data);
                    }
                };
            }
        });
    </script>
    <!--end::Livewire Confirm Integration Script-->
